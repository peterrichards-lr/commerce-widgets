...
/**
 * Provides the local service interface for SkuInventory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Peter Richards
 * @see SkuInventoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SkuInventoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.liferaybotics.service.impl.SkuInventoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sku inventory local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SkuInventoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<SkuInventory> findLowestStock(
