 ...
 * @generated
 */
@Component(service = SkuSalesPersistence.class)
public class SkuSalesPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new SkuSalesModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", SkuSales.class.getName()));
	...
	private static class SkuSalesModelArgumentsResolver
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						skuSalesModelImpl.getColumnBitmask(columnName);
				}
